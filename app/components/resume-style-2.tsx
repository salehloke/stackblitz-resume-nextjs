...
const ResumeStyle2: React.FC<ResumeProps> = ({ data }) => {
  return (
    <div className="max-w-4xl mx-auto p-10 bg-gradient-to-br from-white to-gray-50 shadow-2xl rounded-3xl border border-gray-300">
      {/* Contact Information */}
      <header className="text-center mb-12">
        <h1 className="text-5xl font-extrabold text-gray-900 mb-4">{data.contactInformation.fullName}</h1>
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-gray-800 mb-6 border-b-4 border-gray-300 pb-2">Professional Summary</h2>
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-gray-800 mb-6 border-b-4 border-gray-300 pb-2">Professional Experience</h2>
      ...
      <section>
        <h2 className="text-3xl font-bold text-gray-800 mb-6 border-b-4 border-gray-300 pb-2">Additional Information</h2>
